...
for folder_name_outer in folder_names_outer:
    ...
    if len(folder_names_inner) > 0:  # overwrites file names
        for folder_name_inner in folder_names_inner:
            ...
            for file_name in file_names:
                ...
                pic, save_status = process_alpha(pic_in)
                if len(file_name_split) < 3:
                    continue
                mask, flag_mask = check_if_mask_exists(file_name_split[0] + '_' + file_name_split[1] + '_' + file_name_split[2][
                        0] + '_m.png')
